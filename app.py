...
MRPL_BACKGROUND_URL = "https://raw.githubusercontent.com/mrupendrakushwaha/MRPL-Smart-Manufacturing/main/Mrpl.jpg"
...
st.markdown(
    ...
    .stApp::before {{
        ...
        inset: 0;
        z-index: 0;
        background-image: url("{MRPL_BACKGROUND_URL}");
