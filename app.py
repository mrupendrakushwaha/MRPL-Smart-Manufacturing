...
st.markdown(
    ...
    /* =========================================================
       APP HEADER (main title bar, replaces old red/orange text)
       ========================================================= */
    ...
    /* Section / page title used inside modules (e.g. Dashboard) */
    .mrpl-page-title {{
        display: flex;
        align-items: center;
        gap: 10px;
    ...
    /* =========================================================
       FINAL UI POLISH — SIDEBAR PROFILE + COLLAPSE BUTTON
       Only visual styling; no functionality changed.
       ========================================================= */
    ...
    header[data-testid="stHeader"] button[title*="Sidebar"] {{
        ...
        background: rgba(10, 30, 48, 0.92) !important;
        border: 1px solid rgba(72, 168, 220, 0.28) !important;
    ...
    /* Navigation items — clean professional menu, no native radio dot */
    ...
    /* Hide the default circular radio indicator entirely */
