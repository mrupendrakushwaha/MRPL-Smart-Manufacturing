...
:root{
    --mrpl-accent:#3aa0c4;
    --mrpl-accent-2:#5cc0e0;
    --mrpl-bg-1:#0a151d;
    --mrpl-bg-2:#101f2b;
    --mrpl-surface:#101f2b;
    --mrpl-surface-solid:#101f2b;
    --mrpl-border:#26333f;
    --mrpl-text:#eef5f9;
    --mrpl-text-dim:#7d93a3;
}

html, body, [class*="css"] {font-family:'Plus Jakarta Sans', sans-serif;}

.stApp {
    background: linear-gradient(160deg, rgba(8,17,24,.94) 0%, rgba(10,21,29,.92) 45%, rgba(8,17,24,.96) 100%), __MRPL_BG__;
    background-size:cover; background-position:center; background-attachment:fixed;
    color:var(--mrpl-text);
}
.block-container {max-width:1480px;padding:1.4rem 2.1rem 3rem;}
header[data-testid="stHeader"] {background:rgba(255,255,255,.97);}
h1,h2,h3,h4 {font-family:'Sora', sans-serif; letter-spacing:-.01em;}
::-webkit-scrollbar{width:9px;height:9px;}
::-webkit-scrollbar-thumb{background:#26333f;border-radius:8px;}
::-webkit-scrollbar-track{background:transparent;}

/* SIDEBAR */
section[data-testid="stSidebar"] {background:#0e1a24 !important;border-right:1px solid var(--mrpl-border);}
...
.mrpl-logo {width:46px;height:46px;border-radius:8px;display:flex;align-items:center;justify-content:center;background:var(--mrpl-accent);font-size:22px;}
...
.mrpl-user-card {background:#132531;border:1px solid var(--mrpl-border);border-radius:8px;padding:14px 16px;margin-bottom:12px;}
.mrpl-user-name {font-size:16px;font-weight:800;color:#fff;}
.mrpl-user-role {font-size:11.5px;font-weight:700;color:var(--mrpl-accent-2);margin-top:4px;text-transform:uppercase;letter-spacing:.4px;}
...
section[data-testid="stSidebar"] [role="radiogroup"] > label {background:transparent;border:1px solid transparent;border-left:2px solid transparent;border-radius:5px;padding:9px 12px;margin:0 !important;transition:all .15s ease;}
section[data-testid="stSidebar"] [role="radiogroup"] > label:hover {background:#152a38;border-left:2px solid var(--mrpl-accent);}
section[data-testid="stSidebar"] .stButton > button {background:transparent;border:1px solid rgba(255,90,90,.4);color:#ff9a9a;border-radius:6px;font-weight:700;box-shadow:none;}
section[data-testid="stSidebar"] .stButton > button:hover {background:rgba(255,90,90,.1);border-color:#ff5a5a;color:#fff;}

/* MAIN APP HEADER */
.mrpl-appbar {display:flex;align-items:center;justify-content:space-between;gap:15px;background:var(--mrpl-surface);border:1px solid var(--mrpl-border);border-radius:8px;padding:20px 26px;margin-bottom:20px;}
...
.mrpl-status {display:flex;align-items:center;gap:8px;background:#132531;border:1px solid var(--mrpl-border);padding:8px 14px;border-radius:6px;color:var(--mrpl-accent-2);font-size:12px;font-weight:700;}
.mrpl-dot {width:7px;height:7px;border-radius:50%;background:var(--mrpl-accent-2);display:inline-block;}

/* CARDS / METRICS */
div[data-testid="stVerticalBlockBorderWrapper"] {background:var(--mrpl-surface-solid);border:1px solid var(--mrpl-border);border-radius:8px;}
div[data-testid="stMetric"] {background:var(--mrpl-surface-solid);border:1px solid var(--mrpl-border);border-radius:8px;padding:16px 18px;}
div[data-testid="stMetricLabel"] {color:var(--mrpl-text-dim) !important;font-weight:700 !important;text-transform:uppercase;letter-spacing:.3px;}
div[data-testid="stMetricLabel"] p {color:var(--mrpl-text-dim) !important;font-weight:700 !important;text-transform:uppercase;letter-spacing:.3px;}
...
button[data-baseweb="tab"][aria-selected="true"] {color:var(--mrpl-accent-2) !important;}
div[data-baseweb="tab-highlight"] {background-color:var(--mrpl-accent-2) !important;}
...
ul[data-baseweb="menu"] li:hover, li[role="option"]:hover, li[aria-selected="true"] {
    background:rgba(58,160,196,.16) !important;
    color:#fff !important;
}
.stButton > button,.stLinkButton > a,.stDownloadButton > button {min-height:42px;border-radius:6px;font-weight:700;color:#03222f !important;border:none;background:var(--mrpl-accent);transition:background-color .12s ease;}
.stButton > button:hover,.stLinkButton > a:hover {background:var(--mrpl-accent-2);}
.stButton > button[kind="secondary"] {background:transparent;color:var(--mrpl-text) !important;border:1px solid var(--mrpl-border);}

/* DATAFRAMES */
div[data-testid="stDataFrame"] {border-radius:8px;overflow:hidden;border:1px solid var(--mrpl-border);}

/* E-COMMERCE */
.store-shell {margin-top:4px;}
.store-topbar {display:flex;align-items:center;justify-content:space-between;gap:16px;background:#ffffff;border-radius:8px;padding:14px 20px;margin:0 0 16px;border:1px solid #e0e6ea;}
.store-brand {font-family:'Sora',sans-serif;font-size:21px;font-weight:800;color:#0e1a24;}
.store-tagline {font-size:11px;color:#7c8a9a;margin-top:3px;}
.store-badge-right {font-size:11px;font-weight:800;color:#0f6f8f;background:#e7f4f9;border:1px solid #c8e6f0;border-radius:6px;padding:7px 12px;}
.store-hero {min-height:300px;display:flex;align-items:center;padding:44px;border-radius:8px;overflow:hidden;background-image:linear-gradient(100deg,rgba(8,17,24,.92),rgba(8,17,24,.45)),__MRPL_BG__;background-size:cover;background-position:center;margin-bottom:22px;}
...
.store-pill {display:inline-block;background:rgba(58,160,196,.18);border:1px solid rgba(58,160,196,.4);color:var(--mrpl-accent-2);padding:7px 13px;border-radius:6px;font-size:11px;font-weight:800;letter-spacing:.4px;}
...
.product-category {font-size:10px;font-weight:800;letter-spacing:.8px;text-transform:uppercase;color:var(--mrpl-accent-2);margin-top:8px;}
