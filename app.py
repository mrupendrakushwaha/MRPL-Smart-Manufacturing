...
# ============================================================
# Clean Light Corporate UI
# Functionality / database / authentication are intentionally untouched.
# ============================================================
...
st.markdown(
    ...
    :root {{
        --mrpl-blue: #1677e8;
        --mrpl-blue-dark: #0d4f9e;
        --mrpl-blue-soft: #eaf3ff;
        --mrpl-red: #e5232f;
        --mrpl-green: #18a957;
        --mrpl-orange: #f59e0b;
        --mrpl-text: #12233f;
    ...
    .stApp {{
        background:
            radial-gradient(circle at 90% 0%, rgba(22,119,232,.08), transparent 28%),
    ...
    h2 {{
        ...
        font-weight: 800 !important;
        border-left: 4px solid var(--mrpl-blue);
        padding-left: 12px;
    }}
    ...
    hr {{
        border: 0 !important;
        border-top: 1px solid #e2e9f1 !important;
        margin: 1.25rem 0 !important;
    }}

    /* =========================================================
       STREAMLIT SIDEBAR — clean corporate navigation
       ========================================================= */
    ...
    section[data-testid="stSidebar"] {{
        ...
        box-shadow: 8px 0 28px rgba(28,55,90,.07) !important;
    }}
    ...
    [data-testid="stSidebarCollapseButton"] button {{
        ...
        box-shadow: 0 5px 16px rgba(31,78,121,.12) !important;
        color: #185c9e !important;
        transition: all .2s ease !important;
    }}

    section[data-testid="stSidebar"] ~ div button[kind="headerNoPadding"]:hover,
    header button[kind="headerNoPadding"]:hover,
    button[data-testid="stSidebarCollapseButton"]:hover,
    [data-testid="stSidebarCollapseButton"] button:hover {{
        transform: translateY(-1px) scale(1.03) !important;
        border-color: #8fc2f4 !important;
        box-shadow: 0 8px 20px rgba(22,119,232,.18) !important;
        background: #eaf4ff !important;
    }}

    /* Give the native chevron a premium blue tone */
    section[data-testid="stSidebar"] svg {{
        color: #175d9f !important;
    }}
    ...
    section[data-testid="stSidebar"] .stInfo {{
        ...
        box-shadow: 0 5px 18px rgba(27,67,106,.06) !important;
    }}
    ...
    section[data-testid="stSidebar"] [role="radiogroup"] > label:has(input:checked) {{
        background: linear-gradient(90deg,#e7f2ff,#f4f9ff) !important;
        border-color: #b9dafa !important;
        box-shadow: inset 3px 0 0 #1677e8, 0 4px 12px rgba(22,119,232,.07) !important;
    }}
    ...
    section[data-testid="stSidebar"] .stButton > button {{
        background: linear-gradient(135deg,#1677e8,#0e5eb9) !important;
        border: 0 !important;
        border-radius: 11px !important;
        color: white !important;
        font-weight: 750 !important;
        min-height: 42px !important;
        box-shadow: 0 7px 17px rgba(22,119,232,.20) !important;
    }}

    section[data-testid="stSidebar"] .stButton > button:hover {{
        background: linear-gradient(135deg,#2387f5,#1269c7) !important;
    ...
    div[data-testid="stMetric"] {{
        ...
        background: var(--mrpl-card) !important;
        border: 1px solid #dce7f2 !important;
        border-radius: 16px !important;
        padding: 18px 19px !important;
        min-height: 112px !important;
        box-shadow: 0 8px 24px rgba(34,68,103,.08) !important;
    ...
    div[data-testid="stMetric"]::before {{
        ...
        background: linear-gradient(90deg,#1677e8,#35a7ff) !important;
    }}

    div[data-testid="stMetric"]:hover {{
        transform: translateY(-3px) !important;
        box-shadow: 0 13px 30px rgba(34,68,103,.12) !important;
    }}
    ...
    .mrpl-dashboard-title {{
        background: linear-gradient(90deg,#102a49,#1677e8) !important;
    ...
    div[data-testid="stDataFrame"] {{
        ...
        border-radius: 14px !important;
        overflow: hidden !important;
        box-shadow: 0 7px 22px rgba(34,68,103,.07) !important;
    ...
    div[data-testid="stExpander"] {{
        ...
        box-shadow: 0 7px 20px rgba(34,68,103,.06) !important;
    }}
    ...
    div[data-baseweb="select"]:focus-within {{
        border-color: #69aef0 !important;
        box-shadow: 0 0 0 3px rgba(22,119,232,.10) !important;
    }}
    ...
    .stFormSubmitButton > button {{
        ...
        background: linear-gradient(135deg,#1677e8,#0d61bd) !important;
        color: #ffffff !important;
        font-weight: 750 !important;
        box-shadow: 0 6px 16px rgba(22,119,232,.15) !important;
        transition: all .18s ease !important;
    }}
    ...
    .stFormSubmitButton > button:hover {{
        ...
        background: linear-gradient(135deg,#2387f5,#1169c7) !important;
        box-shadow: 0 10px 22px rgba(22,119,232,.20) !important;
    }}

    .stButton > button[kind="primary"] {{
        background: linear-gradient(135deg,#18a957,#118447) !important;
        border-color: #78d0a0 !important;
    }}

    /* =========================================================
       EXISTING PUBLIC PRODUCTS UI
       ========================================================= */
    ...
    .store-header {{
        ...
        border: 1px solid #dce7f1 !important;
        border-radius: 16px !important;
        box-shadow: 0 8px 24px rgba(34,68,103,.07) !important;
    }}
    ...
    /* Keep hero/image functionality, only soften the presentation */
    .store-hero {{
        border: 1px solid #d9e5ef !important;
        box-shadow: 0 14px 34px rgba(34,68,103,.12) !important;
    }}
...
st.sidebar.markdown(
    ...
    <div style="
        ...
        box-shadow:0 6px 18px rgba(34,68,103,.06);
    ">
        <div style="display:flex;align-items:center;gap:11px;">
            <div style="
                width:42px;height:42px;border-radius:50%;
                background:linear-gradient(135deg,#1677e8,#38a2ff);
                color:#fff;display:flex;align-items:center;
                justify-content:center;font-size:18px;font-weight:800;
                box-shadow:0 5px 12px rgba(22,119,232,.20);
            ">{str(username)[:1].upper()}</div>
            <div>
                <div style="font-size:15px;font-weight:800;color:#17304e;">{username}</div>
                <div style="font-size:10px;font-weight:800;letter-spacing:1px;color:#6b86a2;text-transform:uppercase;">{user_role}</div>
            </div>
        </div>
    </div>
    """,
...
st.sidebar.markdown(
    '<div style="font-size:17px;font-weight:800;color:#17304e;margin:6px 0 2px;">Navigation</div>'
    '<div style="font-size:11px;color:#8090a3;margin-bottom:10px;">Select a module to continue</div>',
    unsafe_allow_html=True
)
...
if selected_module == "📊 Dashboard":
    st.markdown(
        '<div class="mrpl-dashboard-title">📊 Management Dashboard</div>'
        '<div class="mrpl-dashboard-subtitle">Real-time overview of materials, production, inventory and dispatch operations.</div>',
        unsafe_allow_html=True
    )
    ...
    with c1:
        if not production.empty:
            st.markdown(
                '<div style="background:#fff;border:1px solid #dce7f1;border-radius:15px;padding:16px 18px 10px;box-shadow:0 7px 22px rgba(34,68,103,.07);">'
                '<div style="font-size:16px;font-weight:800;color:#17304e;">🏭 Production by Status</div></div>',
                unsafe_allow_html=True
            )
    ...
    with c2:
        if not orders.empty:
            st.markdown(
                '<div style="background:#fff;border:1px solid #dce7f1;border-radius:15px;padding:16px 18px 10px;box-shadow:0 7px 22px rgba(34,68,103,.07);">'
                '<div style="font-size:16px;font-weight:800;color:#17304e;">📝 Orders by Status</div></div>',
                unsafe_allow_html=True
            )
