...
<style>
.stApp {
    background: linear-gradient(rgba(4,18,32,.84),rgba(4,18,32,.88)),__MRPL_BG__;
    background-size:cover; background-position:center; background-attachment:fixed; color:#eaf4fb;
}
.block-container {max-width:1500px;padding:1.25rem 2rem 2.5rem;}
header[data-testid="stHeader"] {background:rgba(255,255,255,.94);}

/* SIDEBAR */
section[data-testid="stSidebar"] {background:linear-gradient(180deg,#061a2e 0%,#041322 100%) !important;border-right:1px solid #183a58;}
section[data-testid="stSidebar"] > div {background:transparent !important;}
section[data-testid="stSidebar"] .block-container {padding:1rem .9rem 2rem;}
.mrpl-side-brand {display:flex;align-items:center;gap:12px;padding:14px 14px 18px;border-bottom:1px solid #183a58;margin-bottom:16px;}
.mrpl-logo {width:48px;height:48px;border-radius:13px;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#0d7ec1,#0a416d);font-size:25px;box-shadow:0 8px 18px rgba(0,0,0,.22);}
.mrpl-side-title {font-size:19px;font-weight:850;color:#fff;line-height:1.05;}
.mrpl-side-sub {font-size:11px;color:#8fa9bf;margin-top:5px;}
.mrpl-user-card {background:linear-gradient(135deg,#0a334a,#083052);border:1px solid #175271;border-radius:15px;padding:15px;margin-bottom:10px;}
.mrpl-user-name {font-size:17px;font-weight:800;color:#fff;}
.mrpl-user-role {font-size:12px;color:#9edbff;margin-top:5px;}
.mrpl-nav-title {font-size:12px;font-weight:800;color:#7190a8;text-transform:uppercase;letter-spacing:1.1px;margin:18px 4px 8px;}
section[data-testid="stSidebar"] [data-testid="stRadio"] > label {color:#d8e7f2 !important;font-weight:700 !important;font-size:13px !important;}
section[data-testid="stSidebar"] [role="radiogroup"] {gap:6px;}
section[data-testid="stSidebar"] [role="radiogroup"] > label {background:#09243c;border:1px solid #123b59;border-radius:11px;padding:8px 10px;margin:0 !important;}
section[data-testid="stSidebar"] [role="radiogroup"] > label:hover {background:#0c3554;border-color:#267eae;}
section[data-testid="stSidebar"] .stButton > button {background:linear-gradient(135deg,#0b78b9,#09527f);border:1px solid #247ead;color:#fff;border-radius:11px;font-weight:800;}

/* MAIN APP HEADER */
.mrpl-appbar {display:flex;align-items:center;justify-content:space-between;gap:15px;background:rgba(7,29,48,.92);border:1px solid #1c4565;border-radius:18px;padding:18px 22px;margin-bottom:18px;box-shadow:0 12px 28px rgba(0,0,0,.20);}
.mrpl-appbar-title {font-size:26px;font-weight:850;color:#fff;}
.mrpl-appbar-sub {font-size:12px;color:#91abc0;margin-top:4px;}
.mrpl-status {display:flex;align-items:center;gap:8px;background:#0a2941;border:1px solid #1a4d6d;padding:8px 12px;border-radius:999px;color:#bfe8ff;font-size:12px;font-weight:700;}
.mrpl-dot {width:8px;height:8px;border-radius:50%;background:#20d59b;display:inline-block;}

/* CARDS / METRICS */
div[data-testid="stVerticalBlockBorderWrapper"] {background:rgba(8,31,51,.94);border:1px solid #1b4768;border-radius:16px;box-shadow:0 10px 26px rgba(0,0,0,.18);}
div[data-testid="stMetric"] {background:linear-gradient(145deg,#0d3555,#09263f);border:1px solid #1b4c6e;border-radius:14px;padding:14px 16px;box-shadow:0 7px 18px rgba(0,0,0,.18);}
div[data-testid="stMetricLabel"] {color:#9bb3c7 !important;}
div[data-testid="stMetricValue"] {color:#fff !important;font-weight:850;}

/* INPUTS / BUTTONS */
div[data-baseweb="input"],div[data-baseweb="select"],textarea,input {background:#09243c !important;color:#f1f7fb !important;border-color:#24506e !important;}
div[data-baseweb="select"] * {color:#f1f7fb !important;}
.stButton > button,.stLinkButton > a,.stDownloadButton > button {min-height:42px;border-radius:11px;font-weight:800;color:#fff !important;border:1px solid #2478a8;background:linear-gradient(135deg,#0c73b4,#0b4e7c);box-shadow:0 6px 14px rgba(0,0,0,.16);}
.stButton > button:hover,.stLinkButton > a:hover {border-color:#42c2ff;background:linear-gradient(135deg,#1087cc,#0d5d8d);}

/* E-COMMERCE */
.store-shell {margin-top:4px;}
.store-topbar {display:flex;align-items:center;justify-content:space-between;gap:16px;background:#fff;border-radius:15px;padding:13px 18px;margin:0 0 14px;box-shadow:0 7px 20px rgba(0,0,0,.16);border:1px solid #e0e8ef;}
.store-brand {font-size:22px;font-weight:900;color:#102f49;}
.store-tagline {font-size:11px;color:#718096;margin-top:3px;}
.store-badge-right {font-size:11px;font-weight:800;color:#0c659c;background:#eaf7ff;border:1px solid #ccecff;border-radius:999px;padding:7px 11px;}
.store-hero {min-height:310px;display:flex;align-items:center;padding:40px;border-radius:20px;overflow:hidden;background-image:linear-gradient(90deg,rgba(4,20,35,.91),rgba(4,20,35,.52)),__MRPL_BG__;background-size:cover;background-position:center;box-shadow:0 12px 30px rgba(0,0,0,.22);margin-bottom:20px;}
.store-hero-content {max-width:760px;}
.store-hero-title {color:#fff;font-size:42px;line-height:1.08;font-weight:900;margin:8px 0 10px;}
.store-hero-text {color:#dce9f3;font-size:15px;line-height:1.65;max-width:650px;}
.store-pill {display:inline-block;background:rgba(255,255,255,.13);border:1px solid rgba(255,255,255,.27);color:#fff;padding:7px 12px;border-radius:999px;font-size:11px;font-weight:850;letter-spacing:.3px;}
.store-section-title {font-size:28px;font-weight:900;color:#fff;margin:8px 0 3px;}
.store-section-subtitle {font-size:13px;color:#b8cad8;margin-bottom:14px;}
.product-category {font-size:10px;font-weight:850;letter-spacing:.7px;text-transform:uppercase;color:#50c3ff;margin-top:8px;}
.product-name {font-size:18px;font-weight:850;color:#fff;margin:4px 0;}
.product-description {font-size:12px;line-height:1.55;color:#b8cad8;}

@media(max-width:768px){.block-container{padding:.8rem .65rem 2rem;}.mrpl-appbar{padding:15px;}.mrpl-appbar-title{font-size:20px;}.mrpl-status{display:none;}.store-hero{min-height:285px;padding:25px;}.store-hero-title{font-size:30px;}.store-hero-text{font-size:13px;}.store-topbar{padding:12px 14px;}.store-badge-right{display:none;}}
</style>
"""
