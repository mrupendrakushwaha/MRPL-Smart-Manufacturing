...
/* CARDS / METRICS */
div[data-testid="stVerticalBlockBorderWrapper"] {background:var(--mrpl-surface);backdrop-filter:blur(12px);border:1px solid var(--mrpl-border);border-radius:18px;box-shadow:0 12px 30px rgba(0,0,0,.22);}
div[data-testid="stMetric"] {background:linear-gradient(150deg, rgba(47,214,192,.10), rgba(90,168,255,.06));border:1px solid var(--mrpl-border);border-radius:16px;padding:16px 18px;box-shadow:0 8px 20px rgba(0,0,0,.2);}
div[data-testid="stMetricLabel"] {color:var(--mrpl-text-dim) !important;font-weight:600 !important;}
...
/* INPUTS / BUTTONS */
div[data-baseweb="input"],div[data-baseweb="select"],textarea,input {background:rgba(255,255,255,.04) !important;color:var(--mrpl-text) !important;border-color:var(--mrpl-border) !important;border-radius:10px !important;}
