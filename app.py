...
st.markdown(
    ...
    /* =========================================================
       TARGET UI — CLEAN MRPL CORPORATE LOOK
       Visual-only overrides. Existing app content/functionality untouched.
       ========================================================= */
    ...
    header[data-testid="stHeader"] {
        ...
        box-shadow: 0 1px 8px rgba(20,33,61,.05) !important;
    }
    ...
    section[data-testid="stSidebar"] {
        ...
        box-shadow: 4px 0 18px rgba(20,33,61,.05) !important;
    }
    ...
    section[data-testid="stSidebar"] [role="radiogroup"] > label:has(input:checked) {
        background: linear-gradient(90deg,#e8f2ff,#f4f8ff) !important;
        border-color: #c9def7 !important;
        box-shadow: inset 3px 0 0 #1677e8 !important;
    }
    ...
    section[data-testid="stSidebar"] [role="radiogroup"] > label:has(input:checked) p {
        color: #1268c9 !important;
        font-weight: 700 !important;
    }

    /* The little sidebar collapse/expand control: make it a proper button */
    ...
    button[aria-label="Expand sidebar"] {
        ...
        box-shadow: 0 5px 16px rgba(22,119,232,.14) !important;
    ...
    button[aria-label="Expand sidebar"]:hover {
        ...
        box-shadow: 0 7px 20px rgba(22,119,232,.22) !important;
    }
    ...
    /* Existing metric cards — keep the same information, only restyle */
    div[data-testid="stMetric"] {
        background: #ffffff !important;
        border: 1px solid #dfe7f0 !important;
        border-radius: 16px !important;
        padding: 18px 20px !important;
        box-shadow: 0 5px 18px rgba(20,33,61,.055) !important;
        min-height: 112px !important;
    }

    div[data-testid="stMetric"]::before {
        background: linear-gradient(90deg,#1677e8,#22b8c7) !important;
        height: 3px !important;
    ...
    /* Buttons — corporate, not oversized */
    .stButton > button,
    .stDownloadButton > button,
    .stFormSubmitButton > button,
    .stLinkButton > a {
        ...
        font-weight: 650 !important;
        box-shadow: 0 3px 10px rgba(20,33,61,.05) !important;
        transition: all .16s ease !important;
    }
    ...
    .stButton > button[kind="primary"] {
        background: linear-gradient(135deg,#1677e8,#2f8df5) !important;
        border-color: #1677e8 !important;
        color: #ffffff !important;
        box-shadow: 0 6px 16px rgba(22,119,232,.22) !important;
    }
    ...
    div[data-baseweb="select"] > div:focus-within {
        border-color: #75afe8 !important;
        box-shadow: 0 0 0 2px rgba(22,119,232,.10) !important;
    }
    ...
    [data-testid="stDataFrame"] {
        ...
        box-shadow: 0 4px 14px rgba(20,33,61,.04) !important;
    }

    /* Keep the public/product hero images and existing content intact. */
