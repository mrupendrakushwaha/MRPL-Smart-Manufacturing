...
# ============================================================
# LOGIN SCREEN + PUBLIC OUR PRODUCTS
# ============================================================
...
def show_public_products():
    st.title("🏭 Mahakoshal Refractories")
    st.caption("Public Product Catalogue — Login is not required")

    st.markdown("## 🌐 Our Products")

    category = st.selectbox(
        "Select Product Category",
        ["All Products", "Shaped Products", "Unshaped Products"],
    ...
    products = {
        "Shaped Products": [
            {
                "name": "Fireclay & High Alumina Bricks",
                "description": "High-performance refractory bricks for high-temperature industrial applications. MRPL offers high alumina grades with alumina content up to 92%.",
                "image": "https://mahakoshalrefractories.com/wp-content/uploads/2025/10/01_0004_Fire-Clay.jpg",
                "url": "https://mahakoshalrefractories.com/products/shaped-refractory-products/fireclay-and-high-alumina-bricks/"
            },
            {
                "name": "Pre Cast Pre Fired (PCPF) Blocks",
                "description": "Custom-engineered pre-fired refractory blocks designed for high strength, durability and ready-to-install applications.",
                "image": "https://mahakoshalrefractories.com/wp-content/uploads/2025/10/01_0001_PCPF_2.jpg",
                "url": "https://mahakoshalrefractories.com/products/shaped-refractory-products/"
            },
            {
                "name": "Silicon Carbide Bricks & Shapes",
                "description": "Silicon carbide refractory products designed for demanding applications requiring abrasion and corrosion resistance.",
                "image": None,
                "url": "https://mahakoshalrefractories.com/products/shaped-refractory-products/"
            },
            {
                "name": "Acid-resistant Bricks",
                "description": "Acid-resistant refractory solutions for corrosive industrial environments and chimney applications.",
                "image": None,
                "url": "https://mahakoshalrefractories.com/products/shaped-refractory-products/"
            }
        ],
        "Unshaped Products": [
            {
                ...
                "description": "Monolithic refractory castables for demanding high-temperature industrial applications.",
                "image": None,
                "url": "https://mahakoshalrefractories.com/products/unshaped-refractory-products/"
            },
            {
                "name": "Low & Ultra Low Cement Castables",
                "description": "Low-cement and ultra-low-cement monolithic refractory solutions for high-performance linings.",
                "image": None,
                "url": "https://mahakoshalrefractories.com/products/unshaped-refractory-products/"
            },
            {
                "name": "Insulating Castables",
                "description": "Insulating refractory castables designed to support thermal insulation in high-temperature equipment.",
                "image": None,
                "url": "https://mahakoshalrefractories.com/products/unshaped-refractory-products/"
            },
            {
                "name": "Plastic Masses",
                "description": "Plastic refractory masses for installation and repair applications requiring adaptable monolithic materials.",
                "image": None,
                "url": "https://mahakoshalrefractories.com/products/unshaped-refractory-products/"
            },
            {
                "name": "High Alumina Refractory Cement / Binders",
                "description": "High alumina refractory cement and binder solutions used in refractory formulations.",
                "image": None,
                "url": "https://mahakoshalrefractories.com/products/unshaped-refractory-products/"
            },
            {
                "name": "Grouting Materials",
                "description": "Grouting materials designed for bonding, stability and durability in demanding industrial environments.",
                "image": None,
                "url": "https://mahakoshalrefractories.com/products/unshaped-refractory-products/grouting-material/"
            },
            {
                "name": "Mortars",
                "description": "Refractory mortars for bonding refractory bricks and linings in high-temperature applications.",
                "image": None,
                "url": "https://mahakoshalrefractories.com/products/unshaped-refractory-products/fire-clay-high-alumina-mortars-heat-setting/"
            },
            {
                "name": "Gunning Mixes / Gunning Castables",
                "description": "Gunning refractory solutions for fast application in critical kiln, cooler, preheater and furnace zones.",
                "image": None,
                "url": "https://mahakoshalrefractories.com/products/unshaped-refractory-products/gunning-castables/"
            }
        ]
    }

    categories = products.keys() if category == "All Products" else [category]

    for product_category in categories:
        st.markdown(f"### {product_category}")

        items = products[product_category]

        for start_index in range(0, len(items), 2):
            cols = st.columns(2)

            for col, product in zip(cols, items[start_index:start_index + 2]):
                with col:
                    with st.container(border=True):
                        ...
                        if product["image"]:
                            ...
                            st.markdown(
                                "<div style='font-size:64px;text-align:center;padding:25px;'>📦</div>",
...
if not st.session_state.logged_in:
    ...
    if st.session_state.show_products:
        ...
        st.write("View company products and product information without logging in.")

        if st.button("🌐 Our Products", use_container_width=True):
